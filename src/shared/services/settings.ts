...
export async function getSettingGroups() {
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: 'Waffo',
      description:
        '配置 <a href="https://docs.waffo.ai/integrate/skill" class="text-primary" target="_blank">Waffo Pancake</a> 支付；Webhook 地址为 <code>/api/payment/notify/waffo</code>，需启用订单完成、订阅生命周期和退款事件',
      tab: 'payment',
    },
    {
      name: 'paypal',
    ...
    },
    {
      name: 'grsai',
      title: 'Grsai',
      description: `配置 <a href="https://grsai.ai" class="text-primary" target="_blank">Grsai</a> AI 服务`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      title: 'Waffo Environment',
      type: 'select',
      value: 'test',
      options: [
        { title: '测试环境', value: 'test' },
    ...
    },
    {
      ...
      type: 'password',
      placeholder: 'MIIEv...（仅填写私钥中间的 Base64 内容）',
      group: 'waffo',
      tab: 'payment',
      tip: '只填写下载得到的 API 私钥中间 Base64 内容，不要填写 BEGIN/END，也不要填写 PUBLIC KEY。程序会自动补全 PRIVATE KEY 头尾，仅保存在服务端。',
    },
    {
      name: 'waffo_product_ids',
      title: 'Waffo Product IDs Mapping',
      type: 'textarea',
      attributes: {
        rows: 6,
      },
  ...
  "starter": "PROD_xxx",
  "standard-monthly": "PROD_xxx",
  "premium-yearly_usd": "PROD_xxx"
}`,
      group: 'waffo',
      tab: 'payment',
      tip: '将价格表中的 product_id 映射到 Waffo Product ID。可使用 product_id 或 product_id_currency 作为键，内容必须是有效的 JSON 对象。',
    },
    {
      name: 'paypal_enabled',
      title: '启用 PayPal',
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'spritepixel.com',
      tip: '填写 Plausible 后台里要统计的网站域名，需与站点实际访问域名一致。',
      group: 'plausible',
      tab: 'analytics',
    },
    {
      ...
      type: 'url',
      placeholder: 'https://plausible.io/js/pa-XXXXX.js',
      tip: '粘贴 Plausible 安装代码里的 pa-*.js 完整地址。使用自定义代理域名时，系统会自动把事件上报到同域 /api/event。',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      placeholder: 'sk-...',
      group: 'grsai',
      tip: 'Grsai API Key 用于访问 Grsai API',
      tab: 'ai',
    },
    {
      name: 'grsai_base_url',
      title: 'Grsai Base URL',
      type: 'url',
      placeholder: 'https://grsaiapi.com',
      value: 'https://grsaiapi.com',
      group: 'grsai',
      tip: '可切换为 Grsai 国内节点',
      tab: 'ai',
    },
    {
      name: 'grsai_custom_storage',
      title: 'Grsai 自定义存储',
      type: 'switch',
      value: 'false',
      group: 'grsai',
      tab: 'ai',
      tip: '使用自定义存储保存 Grsai 生成的文件',
    },
    {
      name: 'adsense_code',
      title: 'AdSense Code',
