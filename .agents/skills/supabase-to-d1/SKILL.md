...
```bash
python3 .Codex/skills/supabase-to-d1/scripts/pg2d1.py supabase_data.sql > d1_data.sql
```

On Windows (if `python3` is not recognized):
```powershell
python .Codex/skills/supabase-to-d1/scripts/pg2d1.py supabase_data.sql > d1_data.sql
```
